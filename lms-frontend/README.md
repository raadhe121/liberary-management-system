...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/azG8n4dQD0)
...
```sh
npx nx serve lms-frontend
```

To create a production bundle:

```sh
npx nx build lms-frontend
```

To see all available targets to run for a project, run:

```sh
npx nx show project lms-frontend
```
